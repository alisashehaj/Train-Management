      ...
      <div class="inner">
        ...
        <ul class="contact">
          <li class="icon solid fa-home">
            ...
            Web Development Project - CS453<br />

          </li>
          <li class="icon solid fa-phone">+355 69 579 5601</li>
          <li class="icon brands fa-twitter"><a href="https://twitter.com/LeJhin1">twitter.com/Le_Jhin1</a></li>
        </ul>
        <ul class="copyright">
          <li>&copy; Online Railway Reservation System.</li>
          <li>Developed By: <a href="https://sixhei-tartari.vercel.app/">Sixhei Tartari</a></li>
        </ul>
      </div>
    </section>
